...
window.RaidList = [
    ...
    new RaidData("Tiamat Omega +", 305081, RAID_TIER.Magna, 120, 1, 45, [18], [6], ELEMENTS.wind, "2040020000_ex_plus.png"),
    ...
    new RaidData("Colossus Omega +", 305091, RAID_TIER.Magna, 120, 1, 45, [19], [6], ELEMENTS.fire, "2040034000_ex_plus.png"),
    ...
    new RaidData("Leviathan Omega +", 305101, RAID_TIER.Magna, 120, 1, 45, [20], [6], ELEMENTS.water, "2040028000_ex_plus.png"),
    ...
    new RaidData("Yggdrasil Omega +", 305111, RAID_TIER.Magna, 120, 1, 45, [21], [6], ELEMENTS.earth, "2040027000_ex_plus.png"),
    ...
    new RaidData("Luminiera Omega +", 305121, RAID_TIER.Magna, 120, 1, 45, [26], [6], ELEMENTS.light, "2040047000_ex_plus.png"),
    ...
    new RaidData("Celeste Omega +", 305131, RAID_TIER.Magna, 120, 1, 45, [31], [6], ELEMENTS.dark, "2040046000_ex_plus.png"),
